...
simulate directions robot =
    case String.uncons directions of
        Nothing -> robot
        Just ( 'A', rest ) -> simulate rest (advance robot)
        Just ( 'R', rest ) -> simulate rest (turnRight robot)
        Just ( 'L', rest ) -> simulate rest (turnLeft robot)
        Just ( _, rest )   -> simulate rest robot
